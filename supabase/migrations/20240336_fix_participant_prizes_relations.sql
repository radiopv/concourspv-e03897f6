-- Drop existing participant_prizes table if it exists
drop table if exists public.participant_prizes;

-- Recreate participant_prizes table with proper foreign keys
